package com.lw.lemonweather.view.horizonview;
...
import com.lw.lemonweather.utils.IconUtils;
...
//        setLayerType(View.LAYER_TYPE_SOFTWARE, null);//关闭硬件加速
        ...
        paint1.setColor(mContext.getResources().getColor(com.lw.mvplibrary.R.color.line_back_dark));
        ...
        //折线颜色
        foldLinePaint.setColor(mContext.getResources().getColor(com.lw.mvplibrary.R.color.line_color_2));
        ...
        dashPaint.setColor(mContext.getResources().getColor(com.lw.mvplibrary.R.color.back_white));
        ...
        //底部时间文字颜色
        textPaint.setColor(mContext.getResources().getColor(com.lw.mvplibrary.R.color.search_light_un_color));

        baseLinePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        baseLinePaint.setStrokeWidth(3);
        baseLinePaint.setStyle(Paint.Style.STROKE);
        baseLinePaint.setColor(mContext.getResources().getColor(com.lw.mvplibrary.R.color.slategray));
