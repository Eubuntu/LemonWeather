...
import static com.lw.lemonweather.utils.DateUtils.getNowDateNoLimiter;
import static com.lw.lemonweather.utils.DateUtils.updateTime;
...
import com.lw.lemonweather.adapter.SevenDailyAdapter;
import com.lw.lemonweather.adapter.TodayDetailAdapter;
...
import com.lw.lemonweather.bean.SunMoonResponse;
import com.lw.lemonweather.bean.TodayDetailBean;
import com.lw.lemonweather.contract.MapWeatherContract;
...
import com.lw.lemonweather.view.horizonview.HourlyForecastView;
import com.lw.lemonweather.view.horizonview.IndexHorizontalScrollView;
import com.lw.lemonweather.view.horizonview.ScrollWatched;
import com.lw.lemonweather.view.horizonview.ScrollWatcher;
import com.lw.lemonweather.view.skyview.SunView;
...
public class MapWeatherActivity extends MvpActivity<MapWeatherContract.MapWeatherPresenter>
    ...
    private void initView() {
        ...
        //放大
        bigShowAnim = AnimationUtils.loadAnimation(context, com.lw.mvplibrary.R.anim.scale_big_expand);
        //缩小
        smallHideAnim = AnimationUtils.loadAnimation(context, com.lw.mvplibrary.R.anim.scale_small_close);
